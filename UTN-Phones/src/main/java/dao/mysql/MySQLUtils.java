...
public class MySQLUtils {
    ...
    protected static final String INSERT_USER_QUERY = "insert into users(first_name,surname,dni,birthdate,username,pwd,email,user_type,id_city) values (?,?,?,?,?,?,?,?,?);";
    protected static final String REMOVE_USER_QUERY = "delete from users where id = ?";
    protected static final String UPDATE_USER_QUERY = "update users set first_name=?, surname=?, username=?, dni=? ,birthdate=?, pwd=? ,id_city=?  where id =?";
